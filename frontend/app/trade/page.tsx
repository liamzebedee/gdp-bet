          ...
          {marketState.phase === Phase.Open ? (
            <div className="space-y-4">
              ...
              <button
                ...
                className={`w-full text-white py-2 px-4 rounded text-sm disabled:bg-gray-400 ${
                  mintSide === 'long' 
            ...
            <div className="text-sm text-gray-600">
              Trading is only available during Open phase
            </div>
          )}
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            {marketState.phase === Phase.Settled && (
              <>
                ...
                <div className="flex justify-between">
                  <span>Result:</span>
                  <span className={`font-semibold ${
                    oracleState.gPpm && Number(oracleState.gPpm) > 0 
                      ? 'text-green-600' 
                      : 'text-red-600'
                  }`}>
                    {oracleState.gPpm && Number(oracleState.gPpm) > 0 ? '📈 LONG WINS' : '📉 SHORT WINS'}
                  </span>
                </div>
              </>
            )}
            <div className="flex justify-between">
              <span>Status:</span>
              <span className="font-semibold">
                {oracleState.finalized ? 'Finalized' : 'Awaiting Q3 data'}
              </span>
            </div>
          </div>
        </div>
